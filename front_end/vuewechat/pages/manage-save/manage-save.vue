	...
	<view class="background">
		<view class="box">
			<view>
				...
				<view style="padding-left: 10px;padding-bottom: 10px;"><text
						class="Info1">故障单号 {{dataList.id}}</text></view>
				<view style="padding-left: 10px;padding-bottom: 10px;"><text class="Info">故障类型 {{dataList.category.category_name}}</text>
				</view>
				<view style="border-bottom: 1px solid #e6e6e7;padding-left: 10px;padding-bottom: 10px;"><text
						class="Info2">故障描述 {{dataList.content}}</text></view>
			</view>
			<view v-for="(item,index) in dataList.img_url" :key="index">
				<image :src="item"></image>
			</view>
			<view style="padding-bottom: 10px;">
				<text class="content">留言消息</text><br>
				<uni-list>
